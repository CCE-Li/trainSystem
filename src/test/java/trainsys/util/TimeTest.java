...
public class TimeTest {
    ...
    void validTime_shouldParseCorrectly() {
        // 测试有效时间（下划线分隔）
        Time time1 = new Time("14:30_06-15");
        ...
        assertEquals("14:30_06-15", time1.toString());

        Time time2 = new Time("00:00_01-01");
        assertEquals(0, time2.getHour());
        assertEquals(0, time2.getMin());

        Time time3 = new Time("23:59_12-31");
        assertEquals(23, time3.getHour());
        assertEquals(59, time3.getMin());
        
        // 测试兼容空格格式
        Time time4 = new Time("14:30 06-15");
        assertEquals(14, time4.getHour());
        assertEquals(30, time4.getMin());
    }
    ...
    void invalidFormat_nullString_shouldThrowException() {
        ...
        assertTrue(exception.getMessage().contains("时间格式必须是"));
    }

    @Test
    void invalidFormat_wrongLength_shouldThrowException() {
        // 太短
        assertThrows(IllegalArgumentException.class, () -> new Time("14:30_6-15"));
        assertThrows(IllegalArgumentException.class, () -> new Time("4:30_06-15"));
        
        // 太长
        assertThrows(IllegalArgumentException.class, () -> new Time("14:30:00_06-15"));
        assertThrows(IllegalArgumentException.class, () -> new Time("14:30_2024-06-15"));
    }
    ...
    void invalidFormat_wrongSeparators_shouldThrowException() {
        ...
        Exception exception1 = assertThrows(IllegalArgumentException.class, () -> {
            new Time("14-30_06-15");
        });
        assertTrue(exception1.getMessage().contains("第3位必须是 ':'"));
        
        // 错误的日期分隔符
        assertThrows(IllegalArgumentException.class, () -> {
            new Time("14:30:06-15");  // 冒号代替下划线
        });
    }

    @Test
    void invalidFormat_nonNumericCharacters_shouldThrowException() {
        assertThrows(IllegalArgumentException.class, () -> new Time("ab:cd_06-15"));
        assertThrows(IllegalArgumentException.class, () -> new Time("1a:30_06-15"));
        assertThrows(IllegalArgumentException.class, () -> new Time("14:3b_06-15"));
    }
    ...
    void invalidDate_shouldThrowException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Time("14:30_13-15"));
        assertThrows(IllegalArgumentException.class, () -> new Time("14:30_06-32"));
        assertThrows(IllegalArgumentException.class, () -> new Time("14:30_02-29"));
    }

    @Test
    void timeComparison_shouldWorkCorrectly() {
        Time early = new Time("10:30_06-15");
        Time late = new Time("14:45_06-15");
        Time sameDay = new Time("10:30_06-15");
        Time nextDay = new Time("09:00_06-16");
    ...
    void timeArithmetic_shouldWorkCorrectly() {
        Time time = new Time("23:50_06-15");
        ...
        // 减100分钟
        Time time2 = new Time("01:30_06-15");
    ...
    void timeDifference_shouldCalculateCorrectly() {
        Time time1 = new Time("10:00_06-15");
        Time time2 = new Time("12:30_06-15");
        
        assertEquals(150, time2.differenceInMinutes(time1));
        assertEquals(-150, time1.differenceInMinutes(time2));
        
        // 跨天计算
        Time time3 = new Time("23:00_06-15");
        Time time4 = new Time("01:00_06-16");
    ...
    void intConstructor_shouldWorkCorrectly() {
        ...
        assertEquals("14:30_06-15", time.toString());
    }
}
